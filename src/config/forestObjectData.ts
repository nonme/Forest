...
// NOTE FOR CODE GENERATION: This object should be treated as a constant data source.
// Do not modify this object directly in generated code. Instead, use it as a reference
// and create derived data structures if necessary.
